...
import '../../login_screen/custom_login_screen.dart';
  ...
  void _showLogoutDialog(BuildContext context) {
    showDialog(
      ...
      builder: (BuildContext dialogContext) {
        ...
        return Colors.greenAccent; // Color when hovered
        }
        ...
        (Set<MaterialState> states) {
        if (states.contains(MaterialState.hovered)) {
        return Colors.redAccent; // Color when hovered
        }
        return null; // Use default
        },
        ),
                ...
                onPressed: () {
                  Get.back();
                  print("Logout is Closed Successfully");
                },
                child: Text("No"),
              ),
