...
class EmpDustbinPageScreen extends StatefulWidget {
  @override
  _EmpDustbinPageScreenState createState() => _EmpDustbinPageScreenState();
}

class _EmpDustbinPageScreenState extends State<EmpDustbinPageScreen> {
  bool isLoading = true;
  String errorMessage = "";
